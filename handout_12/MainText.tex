...
\underline{\textbf{123}}, \underline{\textbf{124}}, \underline{\textbf{125}}, \underline{\textbf{126}}, \underline{\textbf{127}}, \underline{\textbf{128}}, \underline{\textbf{129}}, \underline{\textbf{130}}, \underline{\textbf{131}}\\
\vspace{-0.5cm}
...
Die Spalten von $F_N$ sind orthogonal aufeinander.
...
\begin{itemize}
    ...
    \item Es gibt 4 Aufgaben (ca. 45 min pro Aufgabe), 100 Punkte total.
    \item Aufgaben 1 \& 2 sind zusammengesetzt aus Übungen aus dem Übungsskriptum. (konzeptuell sehr nahe an den Übungsaugaben). Aufgaben 1 \& 2 geben zusammen mindestens 40 Punkte.
    \item Aufgaben 3 und 4 sind wie in vorherigen Jahren.
    \item Einziges Hilfsmittel ist die Formelsammlung. Diese wird an der Prüfung bereitgestellt.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Zeitdiskrete Signale (entweder DTFT oder \underline{$\mathcal{Z}-$Transformation})
    \item DFT
\end{enumerate}
...
\vspace*{-0.5cm}
\begin{itemize}
    \item Es gibt 20 alte Prüfungen. Löst möglichst viele davon!
    ...
    \item Die neusten 6 Prüfungen enthalten Aufgaben zu der $\mathcal{Z}-$Transformation. (Das Thema ist also sehr prüfungsrelevant und kommt sehr wahrscheinlich in Aufgabe 3.) Bei allen älteren Prüfungen ist die Aufgabe 3 über die DTFT.  
    ...
    \item Substitutionen in Integralen und Summen müssen sitzen! Es werden zwar bei Rechenfehlern Teilpunkte gegeben, aber ihr verliert trotzdem einige Punkte, die ihr nicht vergeben wollt.
    \item Vegesst nicht eure Lösungswege zu begründen, Achsenbeschriftungen bei Skizzen etc.
    \item Teilaufgaben mit Sternchen können ohne die vorherigen Teilaufgaben gelöst werden. Diese Sternchen können aber möglicherweise bei Aufgaben mit mehreren Lösungswegen ein wenig misleading sein. (z.B. sehr einfacher Lösungsweg unter Verwendung der Lösung der letzten Teilaufgabe, sehr schwerer zweiter Lösungsweg ohne die vorherige Teilaufgabe, aber theoretisch lösbar $\rightarrow$ Sternchen)
\end{itemize}
