...
\underline{\textbf{97}}, 98, 99, 100, 101, \underline{\textbf{102}}, \underline{\textbf{103}}, \underline{\textbf{104}}, 105, 106, \underline{\textbf{107}}, \underline{\textbf{108}}, 109, \underline{\textbf{110}}, \underline{\textbf{111}}, \underline{\textbf{112}}, 113\\
\vspace{-0.5cm}
...
\begin{minipage}[t]{0.48\textwidth} % Left column
    ...
    \]
    \[
    \text{Wir setzen ein: }h \to \hat{x}, \; t \to f, \; T \to \frac{1}{T}
    \]
\end{minipage}
\hfill
