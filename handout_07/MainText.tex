...
\underline{\textbf{67}}, \underline{\textbf{68}}, 69, \underline{\textbf{70}}, 71, \underline{\textbf{72}}, 73, 74, 75, \underline{\textbf{76}}, \underline{\textbf{77}}, 78, \underline{\textbf{79}}, \underline{\textbf{80}}, 81, \underline{\textbf{82}}\\
\vspace{-0.5cm}
...
\begin{enumerate}
    ...
    \item Es gilt \textbf{nicht}, dass $\displaystyle\int_{-\infty}^{\infty} |h(t)|\text{d}t < \infty$, d.h. die Impulsantwort ist nicht absolut integrierbar. Wenn $h\in L^1$ wäre, dann hätten wir für das ideale Tiefpassfilter garantiert \textcolor{red}{\textbf{BIBO-Stabilität}}. Dies ist aber nicht der Fall.
    ...
    \item[1.\&2.] $\implies$ Ideale Tiefpassfilter sind \textcolor{red}{\textbf{nicht realisierbar}} in der Praxis. Wir müssen das Filter kausal und $h$ absolut integrierbar machen! (Für BIBO-Stabilität)
\end{enumerate}
