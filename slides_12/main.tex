...
\begin{frame}{Aufgaben für diese Woche}
    \begin{itemize}
      \item[] \underline{\textbf{123}}, \underline{\textbf{124}}, \underline{\textbf{125}}, \underline{\textbf{126}}, \underline{\textbf{127}}, \underline{\textbf{128}}, \underline{\textbf{129}}, \underline{\textbf{130}}, \underline{\textbf{131}}
        \item[] 
...
\begin{itemize}
    \item[] 
    \item[] 
    \item[] Die Spalten von $F_N$ sind orthogonal aufeinander.
    \item[] 
...
\begin{frame}{Prüfungsinformationen}
    \begin{itemize}
        ...
        \item[] 
        \item Es gibt 4 Aufgaben. (ca. 45 min pro Aufgabe)
        \item[]
...
\begin{frame}{Tipps für die Prüfung}
    \begin{itemize}
        ...
        \item[] 
        \item Die 6 neusten Prüfungen enthalten Aufgaben zu der $\mathcal{Z}-$ Transformation. (Sehr prüfungsrelevant.) Schaut Aufgaben 114-122 dazu nochmals an!
        \item[] 
...
\begin{frame}{Tipps für die Prüfung}
    \begin{itemize}
        ...
        \item[] 
        \item Teilaufgaben mit Sternchen können unabhängig von den vorherigen Teilaufgaben gelöst werden.
      \end{itemize}
\end{frame}
