...
\begin{frame}{Aufgaben für diese Woche}
    \begin{itemize}
      \item[] \underline{\textbf{67}}, \underline{\textbf{68}}, 69, \underline{\textbf{70}}, 71, \underline{\textbf{72}}, 73, 74, 75, \underline{\textbf{76}}, \underline{\textbf{77}}, 78, \underline{\textbf{79}}, \underline{\textbf{80}}, 81, \underline{\textbf{82}}\
        \item[]
...
\begin{frame}{Idealisierte Tiefpassfilter}
    ...
    \item[] 
    \item Wir schreiben $\hat{h}(f) = \underbrace{|\hat{h}(f)|}_{=:\hat{h}_{id}(f)} e^{-2\pi i f t_0} \; \invtransform{2.}{1.5} \; h_{id}(t-t_0)$
    \item[] 
...
\begin{frame}{Idealisierte Tiefpassfilter: Bemerkungen}
    ...
    \item[] 
    \item Es gilt \textbf{nicht}, dass $\displaystyle\int_{-\infty}^{\infty} |h(t)|\text{d}t < \infty$. \\ (Die Impulsantwort is nicht absolut integrierbar)
    \item[] Grund: Riemann-Lebesgue Lemma
    \item[] 
    \item[1.\&2.] $\implies$ Ideale Tiefpassfilter sind \textcolor{red}{\textbf{nicht realisierbar}} in der Praxis. Wir müssen das Filter kausal und h absolut integrierbar (damit BIBO-Stabilität garantiert ist) machen!
\end{enumerate}
\end{frame}
